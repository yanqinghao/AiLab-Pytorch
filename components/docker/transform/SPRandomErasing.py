...
@app.param(
    ListOfFloat(key="ratio", default=[0.3, 3.3], help="range of aspect ratio of erased area."))
@app.param(Int(key="value", default=0, help="erasing value. "))
@app.param(Bool(key="inplace", default=False, help="boolean to make this transform inplace."))

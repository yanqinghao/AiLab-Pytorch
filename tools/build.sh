...
do
    ...
    docker build -t registry-vpc.cn-shanghai.aliyuncs.com/${i}/pytorch-stream-gpu:$1 -f docker/stream_yanqing_gpu/Dockerfile .
    sed -i "s/cpu/cu100/g" .dockerignore
    docker build -t registry-vpc.cn-shanghai.aliyuncs.com/${i}/pytorch-docker:$1 -f docker/docker_yanqing/Dockerfile .
    docker build -t registry-vpc.cn-shanghai.aliyuncs.com/${i}/pytorch-stream:$1 -f docker/stream_yanqing/Dockerfile .
